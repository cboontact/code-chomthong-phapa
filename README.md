...
- ✅ บันทึก แก้ไข และลบรายการ โดยแยกเงินสดและเงินโอน
...
บัญชีผู้ดูแลกำหนดผ่าน Cloudflare Secrets และไฟล์ `.dev.vars` เฉพาะเครื่องของผู้รับผิดชอบ จึงไม่ระบุ username หรือรหัสผ่านจริงใน repository
...
| `cash_amount` | ยอดรับเป็นเงินสด |
| `transfer_amount` | ยอดรับเป็นเงินโอน |
| `amount` | ยอดรวมที่ระบบคำนวณจากเงินสด + เงินโอน |
| `note` | หมายเหตุ |
...
2. กรอก `รุ่นที่`, `ชื่อรุ่น / กลุ่ม`, `เงินสด`, `เงินโอน` และหมายเหตุ
3. ระบบคำนวณยอดรวมอัตโนมัติ และตรวจว่ามียอดอย่างน้อยหนึ่งช่องมากกว่า 0
4. บันทึกเงินสด เงินโอน และยอดรวมลง `donations`
...
2. กรอกเงินสดหรือเงินโอนอย่างน้อยหนึ่งช่อง
3. ตรวจ `ยอดรวมที่จะบันทึก` ที่ระบบคำนวณให้
4. กด `บันทึกรายการ`
5. รอ toast ยืนยัน และตรวจยอดจากหน้าหลักได้ทันที
...
4. `0004_payment_split.sql` เพิ่มช่องเงินสดและเงินโอน พร้อมย้ายยอดเดิมไปเป็นเงินสดเพื่อไม่ให้ข้อมูลสูญหาย
...
- ควรทดลองเพิ่มเงินสด เพิ่มเงินโอน เพิ่มทั้งสองช่อง แก้ไข ลบรายการ และตรวจยอดในหน้าสาธารณะ
